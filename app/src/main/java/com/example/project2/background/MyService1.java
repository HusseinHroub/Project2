...
public class MyService1 extends Service {
    ...
    private class DownloadFilesTask extends AsyncTask<Void, Void, Void> {
        ...
        private void showNotificaiton(int i) {
            ...
            NotificationManagerCompat notificationManager = NotificationManagerCompat.from(MyService1.this);
            notificationManager.notify(3, NotificationManagerr.getNotificationBuilder(MyService1.this,
                    CHANNEL_ID,
                    "Thread notfication",
                    "i is: " + i,
                    true).build());
